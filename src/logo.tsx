...
const Logo: React.FC<ILogo> = ({ page }: ILogo): JSX.Element => {
    const history = useHistory();

    return <svg onClick={() => history.push("/")} className="cursor-pointer" width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">

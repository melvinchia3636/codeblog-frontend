...
const Projects = (): JSX.Element => {
    ...
    const projectTypes: (string|number|ReactElement)[][] = [
        ["Websites", 56, "WEBAPPS/<br>WEBSITES", "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat.", "3 months / projects", "Available", "WA", <svg key="web" className="absolute bottom-0 right-0" width="499" height="408" viewBox="0 0 499 408" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        ["UI Designs", 56, "UI<br>DESIGNS", "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat.", "3 days / projects", "Available", "UI", <svg key="web" className="absolute bottom-0 right-0" width="499" height="408" viewBox="0 0 499 408" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_264:31)" filter="url(#filter0_i_264:31)">
                <path d="M394.282 306.4C396.278 289.933 397.775 273.466 397.775 256.5C397.775 239.534 396.278 223.067 394.282 206.6H478.613C482.605 222.568 485.1 239.285 485.1 256.5C485.1 273.716 482.605 290.432 478.613 306.4H394.282ZM350.121 445.122C365.091 417.427 376.568 387.488 384.552 356.3H458.154C433.982 397.923 395.632 429.453 350.121 445.122ZM343.883 306.4H227.117C224.622 289.933 223.125 273.466 223.125 256.5C223.125 239.534 224.622 222.818 227.117 206.6H343.883C346.129 222.818 347.875 239.534 347.875 256.5C347.875 273.466 346.129 289.933 343.883 306.4ZM285.5 455.102C264.792 425.162 248.075 391.979 237.846 356.3H333.155C322.925 391.979 306.208 425.162 285.5 455.102ZM185.7 156.7H112.846C136.769 114.964 175.091 83.3841 220.63 67.878C205.66 95.5725 194.433 125.513 185.7 156.7ZM112.846 356.3H185.7C194.433 387.488 205.66 417.427 220.63 445.122C175.187 429.445 136.919 397.91 112.846 356.3ZM92.387 306.4C88.395 290.432 85.9 273.716 85.9 256.5C85.9 239.285 88.395 222.568 92.387 206.6H176.718C174.722 223.067 173.225 239.534 173.225 256.5C173.225 273.466 174.722 289.933 176.718 306.4H92.387ZM285.5 57.6485C306.208 87.5885 322.925 121.022 333.155 156.7H237.846C248.075 121.022 264.792 87.5885 285.5 57.6485ZM458.154 156.7H384.552C376.743 125.798 365.18 95.9691 350.121 67.878C396.029 83.5965 434.202 115.283 458.154 156.7ZM285.5 7C147.526 7 36 119.275 36 256.5C36 322.672 62.2865 386.133 109.077 432.923C132.245 456.091 159.75 474.469 190.02 487.008C220.291 499.547 252.735 506 285.5 506C351.672 506 415.133 479.713 461.923 432.923C508.713 386.133 535 322.672 535 256.5C535 223.735 528.547 191.291 516.008 161.02C503.469 130.75 485.091 103.245 461.923 80.0769C438.755 56.9086 411.25 38.5306 380.98 25.9921C350.709 13.4535 318.265 7 285.5 7Z" fill="#1A1A1A"/>
            </g>
            <defs>
        ...
        ["Mobile Apps", 56, "Mobile<br>Apps", "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat.", "3 months / projects", "Available", "MA", <svg key="web" className="absolute bottom-0 right-0" width="499" height="408" viewBox="0 0 499 408" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_264:31)" filter="url(#filter0_i_264:31)">
925 121.022 333.155 156.7H237.846C248.075 121.022 264.792 87.5885 285.5 57.6485ZM458.154 156.7H384.552C376.743 125.798 365.18 95.9691 350.121 67.878C396.029 83.5965 434.202 115.283 458.154 156.7ZM285.5 7C147.526 7 36 119.275 36 256.5C36 322.672 62.2865 386.133 109.077 432.923C132.245 456.091 159.75 474.469 190.02 487.008C220.291 499.547 252.735 506 285.5 506C351.672 506 415.133 479.713 461.923 432.923C508.713 386.133 535 322.672 535 256.5C535 223.735 528.547 191.291 516.008 161.02C503.469 130.75 485.091 103.245 461.923 80.0769C438.755 56.9086 411.25 38.5306 380.98 25.9921C350.709 13.4535 318.265 7 285.5 7Z" fill="#1A1A1A"/>
            </g>
            <defs>
            ...
            <div className="h-full justify-between flex flex-col">
                <Anime initial={[{
                    ...
                    <div className="text-white sidebar font-Poppins text-3xl whitespace-nowrap">
                        <p onClick={() => {setShow(false); setFirst(false); setTimeout(() => {
                            changeCurrentType(1);
                            setShow(true);
                        }, 1000);}} className={`font-Poppins tracking-widerr mb-8 ${currentType === 1 && "text-yellow-500 font-semibold"}`}>Websites</p>
                        <p onClick={() => {setShow(false); setFirst(false); setTimeout(() => {
                            changeCurrentType(2);
                            setShow(true);
                        }, 1000);}} className={`font-Poppins tracking-widerr mb-8 ${currentType === 2 && "text-yellow-500 font-semibold"}`}>UI Designs</p>
                        <p onClick={() => {setShow(false); setFirst(false); setTimeout(() => {
                            changeCurrentType(3);
                            setShow(true);
                        }, 1000);}} className={`font-Poppins tracking-widerr mb-8 ${currentType === 3 && "text-yellow-500 font-semibold"}`}>Mobile Apps</p>
                        <p onClick={() => {setShow(false); setFirst(false); setTimeout(() => {
                            changeCurrentType(4);
                            setShow(true);
                        }, 1000);}} className={`font-Poppins tracking-widerr mb-8 ${currentType === 4 && "text-yellow-500 font-semibold"}`}>Desktop Apps</p>
                        <p onClick={() => {setShow(false); setFirst(false); setTimeout(() => {
                            changeCurrentType(5);
                            setShow(true);
                        }, 1000);}} className={`font-Poppins tracking-widerr mb-8 ${currentType === 5 && "text-yellow-500 font-semibold"}`}>Web Scraping</p>
                    </div>
                </Anime>
            ...
            <div className="h-full justify-between flex flex-col">
                <div>
                    <div className={`${anim} workflow-title relative pl-6 ${show ? "animate__fadeInDown" : "animate__fadeOutUp"}`} style={{borderLeft: "10px solid rgba(254, 206, 60)"}}>
                        <h1 className={`${anim} text-7xl text-white font-bold tracking-widerr uppercase ${show ? "animate__fadeInDown "+(first ? "animate__delay-1s" : "") : "animate__fadeOutRight"}`}>{(projectTypes[currentType-1][2]+"").split("<br>").map(e => <p key="hmm">{e}</p>)}</h1>
                    </div>
                    <button className={`${anim} text-yellow-500 font-bold mt-16 border-yellow-500 border-4 py-5 px-20 uppercase text-2xl tracking-widerr whitespace-nowrap ${show ? "animate__fadeInRight animate__delay-1s" : "animate__fadeOutDown"}`}>BWORSE PROEJCTS</button>
                </div>
                <div className={`${anim} ${show ? "animate__fadeInUp "+(first ? "animate__delay-1s" : "") : "animate__fadeOutDown"}`}>

    ...
    return <nav>
        <div className="absolute z-10 top-6 left-6 flex justify-between" style={{width: "calc(100% - 4rem)"}}>
            ...
            <Anime initial={[
                ...
                <div className="text-white font-Chakra flex gap-16 navbar relative z-10">
                    <button className={`uppercase tracking-widerr text-lg transition-color font-bold ${[0, 1, 2, 3, 6].includes(page) ? "text-black-dark" : "text-yellow-500"} relative z-10`}>HOME</button>
                    <button className={`uppercase tracking-widerr text-lg transition-color font-bold ${[0, 1, 2, 3, 6].includes(page) ? "text-yellow-900" : ""} relative z-10`}>PROJECTS</button>
                    <button className={`uppercase tracking-widerr text-lg transition-color font-bold ${[0, 1, 2, 3, 6].includes(page) ? "text-yellow-900" : ""} relative z-10`}>BLOG</button>
                    <button className={`uppercase tracking-widerr text-lg transition-color font-bold ${[0, 1, 2, 3, 6].includes(page) ? "text-yellow-900" : ""} relative z-10`}>ABOUT</button>
                </div>
            </Anime>
        ...
        <Anime initial={[
            ...
            <div className="text-white z-10 font-Chakra flex gap-16 sidebar transform origin-top-left -rotate-90 absolute bottom-2 left-6">
                <button className={`uppercase tracking-widerr text-lg transition-color font-bold ${[1, 2, 3, 6].includes(page) ? "text-black-dark" : "text-yellow-500"}`}>intro</button>
                <button className={`uppercase tracking-widerr text-lg transition-color font-bold ${[1, 2, 3, 6].includes(page) ? "text-yellow-900" : ""}`}>skills</button>
                <button className={`uppercase tracking-widerr text-lg transition-color font-bold ${[1, 2, 3, 6].includes(page) ? "text-yellow-900" : ""}`}>service</button>
                <button className={`uppercase tracking-widerr text-lg transition-color font-bold ${[1, 2, 3, 6].includes(page) ? "text-yellow-900" : ""}`}>contact</button>
            </div>
        </Anime>
        <Anime initial={[
            {

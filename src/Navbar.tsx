...
const Navbar: React.FC<INavbar> = ({ page, setPage }: INavbar):JSX.Element => {
    ...
    return <nav>
        ...
        <Anime initial={[
            ...
            <div className="text-white font-Chakra flex gap-16 sidebar transform origin-top-left -rotate-90 absolute z-30 bottom-2 left-6">
        ...
        <Anime initial={[
            ...
            <div className="text-white font-Chakra flex gap-12 flex-col items-end absolute bottom-6 right-6 z-30 sidebar2">
